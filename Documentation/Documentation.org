...
+ Les trames sont constituées de la manière suivante:
  * [Version Protocole /8bits/]
  * [Code de Fonction /8bits/]
  * [Arguments /16bits/]

** Version du protocole
+ Version 0 = erreur.
+ Version 1 = version actuelle.
+ Version 2-255 = RFU (Reserved Future Use). Le numéro de version est vérifié lors des communications entre contrôleurs et serveur doit être cohérents. Le numéro de version doit être incrémenter en cas d'ajout ou de modification des fonctions implémentées.

** Les fonctions    
*** V1
| Code fonction | Argument [0] [ Argument [1]
